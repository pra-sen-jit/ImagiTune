            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium rounded-lg hover:from-purple-700 hover:to-blue-700 transition-colors"
                  >
                    Send Message
                  </button>
                </div>
